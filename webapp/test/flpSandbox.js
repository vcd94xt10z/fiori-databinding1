		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori - Testado Databinding",
									"targetURL": "#fioridatabinding1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioridatabinding1-display": {
								"semanticObject": "fioridatabinding1",
								"action": "display",
								"description": "Fiori - Testado Databinding",
								"title": "Fiori - Testado Databinding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioridatabinding1",
									"url": sap.ui.require.toUrl("fioridatabinding1")
								}
							}
						}
					}
